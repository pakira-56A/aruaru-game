...
## 開発継続性を高める追加サービス案
**タグ付け**
- 投稿したあるあるの界隈にタグ付け機能を追加
- タグを辿ると、少し近い界隈のあるあるで遊んで・知って・シェアできます


**プッシュ通知**
- プッシュ通知機能をON/IFF設定で切り替えられる
- ONにした場合の詳細（以下、ユーザーは個別にON/OF設定ができる）
  - **タグの新着を通知**
    - よく見ているタグ上位３つを自動的に、または通知させたいタグの３つ選択させます
    - そのタグをつけた界隈の投稿が、新たにされるとプッシュ通知が届きます
    - 届いたプッシュ通知をタップすると、すぐ遊べます
  - **コメント・いいねをされた際の通知**
    - AI生成させたあるある・投稿したあるあるに、コメント/いいねがあると通知
      - ユーザーはコメント・いいね・両方を通知するか個別で選択できます

**季節イベントを開催**
- 数ヶ月に一度、季節に関するテーマで縛ったイベントを開催
- 例：１・２月開催イベントならば、テーマは`正月` `バレンタイン`等にちなんだあるあるをユーザーに募ります 
- テーマ自体に関するあるあるを生成/投稿するも良し
- 「〇〇(推し)のバレンタインイベント」等と題した（期間を絞った）界隈のあるある生成/投稿をしてもらうもよし
  - 「去年はあーだったのに、今年はこーですねw」と交流してもらうのも狙い
_______
## 当サービスにおける神経衰弱カードの特徴  
